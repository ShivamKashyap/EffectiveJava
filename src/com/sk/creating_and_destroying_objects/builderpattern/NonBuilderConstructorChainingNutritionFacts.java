 ...
 *
 *
 *         Here in this example using factory methods to initalize class would
 *         be a cumbersome task
 *         and so with using constructor chaining as client while creating an
 *         object will likely mess up values
 */
public class NonBuilderConstructorChainingNutritionFacts {
	...
	public NonBuilderConstructorChainingNutritionFacts(int servings, int servingSize, int calories, int fat,
			int carbohydrates,
			int protein) {
	...
	public String toString() {
		return "NonBuilderConstructorChainingNutritionFacts [calcium=" + calcium + ", calories=" + calories
				+ ", carbohydrates=" + carbohydrates + ", fat=" + fat + ", potassium=" + potassium + ", protein="
				+ protein + ", servingSize=" + servingSize + ", servings=" + servings + ", sodium=" + sodium + "]";
	}
